...
void printPathloss(Time period, Ptr<HybridBuildingsPropagationLossModel> model, Ptr<ns3::Node> sender, Ptr<ns3::Node> receiver){
...
{   
    ...
    Ptr<MobilityBuildingInfo> buildingInfoEnb = CreateObject<MobilityBuildingInfo>(b1);
    Ptr<MobilityModel> mob1 = nodes.Get(0)->GetObject<MobilityModel>();
    mob1->AggregateObject(buildingInfoEnb);
    buildingInfoEnb->MakeConsistent(mob1);

    Ptr<MobilityBuildingInfo> buildingInfoUe = CreateObject<MobilityBuildingInfo>(b1);
    Ptr<MobilityModel> mob2 = nodes.Get(1)->GetObject<MobilityModel>();
    mob2->AggregateObject(buildingInfoUe);
    buildingInfoUe->MakeConsistent(mob2);
    
    Ptr<HybridBuildingsPropagationLossModel> FOpropagationLossModel = CreateObject<HybridBuildingsPropagationLossModel>();
