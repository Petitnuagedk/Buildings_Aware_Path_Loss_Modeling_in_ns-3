...
{   
    ...
    Waypoint waypointS1  (Seconds (t1), Vector(10, 10, z)); 
    Waypoint waypointS2  (Seconds (t2), Vector(20, 10, z));
    Waypoint waypointS3  (Seconds (t3), Vector(30, 10, z));
    Waypoint waypointS4  (Seconds (t4), Vector(40, 10, z));
    Waypoint waypointS5  (Seconds (t5), Vector(50, 10, z));
    Waypoint waypointS6  (Seconds (t6), Vector(60, 10, z));
    ...
    waypoints.push_back (waypointS6);

    selfsetWaypoints(nodes.Get(0), waypoints);
    waypoints.clear();
    
    Waypoint waypointD1  (Seconds (t1), Vector(10, 35, z)); 
    Waypoint waypointD2  (Seconds (t2), Vector(20, 35, z));
    Waypoint waypointD3  (Seconds (t3), Vector(30, 35, z));
    Waypoint waypointD4  (Seconds (t4), Vector(40, 35, z));
    Waypoint waypointD5  (Seconds (t5), Vector(50, 35, z));
    Waypoint waypointD6  (Seconds (t6), Vector(60, 35, z));
    ...
    waypoints.push_back (waypointD6);
